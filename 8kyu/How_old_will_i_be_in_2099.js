...
// dates in the past: "You will be born in ... year(s)." If the year of birth equals the year 
// requested return: "You were born this very year!"
...
function calculateAge(birthYear, targetYear) {
    ...
    let difference = Math.abs(targetYear - birthYear);
    let yearWord = difference === 1 ? "year" : "years";

    if (targetYear > birthYear) {
        return `You are ${difference} ${yearWord} old.`;
    } else {
        return `You will be born in ${difference} ${yearWord}.`;
    }
}
console.log(calculateAge(2020,2099));